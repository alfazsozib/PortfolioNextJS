...
function Project() {
  return (
    <div id='project' className=' h-[100%]  max-w-[1644px] mx-auto pt-12 max-md:p-12 max-sm:p-10 pl-80'>
      ...
      <div className='grid grid-cols-2 gap-4 max-md:pr-4 md:grid max-sm:grid-cols-1 max-md:grid max-md:grid-cols-1 '>
      {projects.map((data,index)=>
      <div className='box w-[400px] ' key={index}>
        <div className='content w-[450px] md:w-[350px] max-md:w-[350px] max-sm:w-[300px] h-[330px] p-2 pb-4 border-2 border-[#5800FF] rounded-lg hover:border-[#5800FF]'  >
