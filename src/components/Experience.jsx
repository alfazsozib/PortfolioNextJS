...
function Experience() {
    ...
    return (
        <div id='experience' className='max-sm:p-10 h-[100%] max-w-[1644px] pt-12 max-md:p-12 pl-80'>
            ...
            <>
            <div className='experience-text--box flex max-md:flex-none sm:flex-none justify-between mr-4'>
                <h1 className='text-[22px] max-md:text-[20px] text-titleFont font-bold font-saira'>{data.title}</h1>
            ...
            <div className='company'>
                ...
                <p className='py-4 pb-12 font-openSans text-grayText w-3/4'>{data.details}</p>
            </div>
            </>
            )}
