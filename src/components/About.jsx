    ...
    return (
        <div id='about' className='max-sm:pr-0 w-[100%] h-[100vh] pl-80 max-md:p-12 flex items-center'>
            <div id='text--box' className='flex flex-col'>
                <h1 className='text-6xl max-md:text-4xl font-saira font-bold  text-[#343a40]'>ALFAZ <span className='text-[#36107d]'>HOSAIN</span></h1>
                <p className='leading-6 max-md:leading-8 max-md:text-sm pb-8 font-serif text-grayText font-medium text-xl'>Rajshahi, Bangladesh · +8801304396916 · <span className='text-[#36107d]'><a href="#alfazsozib@gmail.com"> alfazsozib@gmail.com</a></span></p>
